...
public class SpellDictionaryDichoDisk extends SpellDictionaryASpell {
    ...
    public void addWord(String word) {
        throw new RuntimeException("addWord is not implemented for SpellDictionaryDichoDisk");
    }
     ...
     */
    private List<String> dichoFind(String code, long p1, long p2) throws IOException {
    ...
    private List<String> seqFind(String code, long p1, long p2) throws IOException {
